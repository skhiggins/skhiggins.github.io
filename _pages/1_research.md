...
- <details><summary>Abstract</summary><p>Consumer credit finances a large and growing share of global consumption. Marginal propensities to borrow mediate the effects of monetary and fiscal policy, but we know little about how consumers decide how much to borrow and which purchases to finance with debt. We test whether mental accounting, or the idea that consumers separate financial decisions based on how money is categorized, affects consumer borrowing behavior. We conduct a randomized controlled trial (RCT) with Cashea, Venezuela's largest consumer credit provider. Cashea provides two distinct credit lines to all of its borrowers: one for grocery and pharmacy purchases, and one for all other retail goods. We randomized 0%, 50%, or 100% increases on one or both credit lines for 210,000 active users. As predicted by our model of mental accounting, there is a large category-specific marginal propensity to consume (MPC) out of credit line increases of 45% over six months, with limited or no spillovers across categories even for the least constrained users. We find that the same-category MPC is spread across subcategories within each category and persists in each post-experiment month. Survey evidence suggests that these increases reflect higher total spending rather than substitution away from cash purchases. We conclude that consumers mentally account for credit, with economically large effects on borrowing and the allocation of spending across categories.</p></details>
