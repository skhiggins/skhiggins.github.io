...
- <details><summary>Abstract</summary><p>Consumer credit finances a large and growing share of global consumption, but we know little about how consumers decide how much to borrow and which purchases to finance with debt.
We develop a model of mental accounting for credit, or the idea that consumers budget according to non-fungible spending categories that govern their borrowing behavior. 
We test our model in a randomized controlled trial (RCT) with Cashea, Venezuela's largest consumer credit provider. 
Cashea provides two distinct credit lines to all of its borrowers: one for grocery stores and pharmacies, and one for all other retail merchants. 
We randomized 0\%, 50\%, or 100\% credit-limit increases on one or both credit lines for 210,000 active users. 
We present five results in support of our theory of mental accounting for credit: (1) borrowers have large same-category marginal propensities to consume (MPCs) out of credit-limit increases with near-zero cross-category MPCs; (2) the results persist in every post-treatment month; (3) the same-category MPCs represent an increase in total consumption; (4) the results hold separately for both constrained and unconstrained borrowers; and, (5) the results hold separately for each sub-category of consumption within each credit line.
We conclude that consumers mentally account for credit, with economically large effects on borrowing and the allocation of spending across categories, which could have important implications for the effects of monetary and fiscal policy.</p></details>
